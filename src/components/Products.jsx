...
const Products = () => {
  ...
  const handleCommercialWhatsApp = () => {
    const message =
      "Olá! Gostaria de falar com o comercial sobre a compra de equipamentos Starlink e periféricos.";
    window.open(
      `https://wa.me/5547999414770?text=${encodeURIComponent(message)}`,
      "_blank"
    );
  };
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Quer <span className="gradient-text">adquirir a sua?</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Oferecemos uma linha completa de equipamentos Starlink e periféricos
            para todas suas necessidades de conectividade.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {products.map((product, index) => (
            ...
            >
              <div
                className={`w-14 h-14 rounded-xl bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center mb-4 ${product.color}`}
              >
        ...
        >
          <div className="glass rounded-2xl p-8 backdrop-blur-md border border-white/10 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Nossa equipe comercial está pronta para ajudar você a encontrar a
              solução ideal. Fale conosco e receba uma cotação personalizada
